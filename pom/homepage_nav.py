...
class HomepageNav(SeleniumBase):
    def __init__(self, driver):
        ...
        self.driver = driver
        self.__nav_links_locator: str = '#mainNavigationFobs>li'
        self.__close_button_locator: str = '//*[@id="closeButton"]'
        self.NAV_LINK_TEXT = 'Women,Men,Kids & Baby,Home,Shoes,Handbags & Accessories,Jewelry,Sale' 
    
    def get_nav_links(self) -> List[WebElement]:
        return self.are_visible('css', self.__nav_links_locator, 'Header Navigation Links')
    ...
    def get_tiny_box_close_button(self) -> WebElement:
        return self.is_clickable('xpath', self.__close_button_locator, 'Close Button Tiny Box')
