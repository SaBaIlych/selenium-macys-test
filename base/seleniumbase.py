...
class SeleniumBase:
    ...
    def is_not_present(self, find_by: str, locator: str, locator_name: str = None) -> WebElement:
        return self.__wait.until(ec.invisibility_of_element((self.__get_selenium_by(find_by), locator)), locator_name)
    ...
    def is_clickable(self, find_by: str, locator: str, locator_name: str = None) -> List[WebElement]:
